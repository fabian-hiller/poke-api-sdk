import { Generation, GenerationList } from '../types/index.ts';

export const generationList: GenerationList = {
  count: 9,
  next: null,
  previous: null,
  results: [
...
export const generationListLimit2: GenerationList = {
  count: 9,
...
export const generationI: Generation = {
  abilities: [],
  id: 1,
